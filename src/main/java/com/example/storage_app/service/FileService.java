...
public interface FileService {
    ...
    FileResponse uploadFile(String userId, MultipartFile file, FileUploadRequest request) throws IOException, NoSuchAlgorithmException;

    Page<FileResponse> listFiles(String userId, String tag, String sortBy, String sortDir, int page, int size);
